  ...
  function CodeMirror(place, givenOptions) {
    ...
    function handleKeyBinding(e) {
			...
			if (typeof e.mobile !== "undefined") {
				metaKey |= typeof e.mobile.metaKey !== "undefined" && e.mobile.metaKey !== null && e.mobile.metaKey;
				ctrlKey |= typeof e.mobile.ctrlKey !== "undefined" && e.mobile.ctrlKey !== null && e.mobile.ctrlKey;
				altKey |= typeof e.mobile.altKey !== "undefined" && e.mobile.altKey !== null && e.mobile.altKey;
				shiftKey |= typeof e.mobile.shiftKey !== "undefined" && e.mobile.shiftKey !== null && e.mobile.shiftKey;
				if (typeof e.mobile.keyCode !== "undefined" && e.mobile.keyCode !== null)
					keyCode = e.mobile.keyCode;
			}

      var name = keyNames[keyCode], next = keyMap[options.keyMap].auto, bound, dropShift;
      if (name == null || e.altGraphKey) {
        if (next) options.keyMap = next;
        return null;
      }
      if (altKey) name = "Alt-" + name;
      if (ctrlKey) name = "Ctrl-" + name;
      if (metaKey) name = "Cmd-" + name;
      if (shiftKey && (bound = lookupKey("Shift-" + name, options.extraKeys, options.keyMap))) {
        dropShift = true;
      } else {
    ...
    function onKeyDown(e) {
      ...
      if (options.onKeyEvent && options.onKeyEvent(instance, addStop(e))) return;
			...
			if (typeof e.mobile !== "undefined") {
				...
				shiftKey |= typeof e.mobile.shiftKey !== "undefined" && e.mobile.shiftKey !== null && e.mobile.shiftKey;
				if (typeof e.mobile.keyCode !== "undefined" && e.mobile.keyCode !== null)
					code = e.mobile.keyCode;
			}

       // IE does strange things with escape.
      if (ie && code == 27) { e.returnValue = false; }
      setShift(code == 16 || shiftKey);
      var handled = handleKeyBinding(e);
      if (window.opera) {
        lastStoppedKey = handled ? code : null;
        // Opera has no cut event... we try to at least catch the key combo
        if (!handled && ((mac || ios) ? metaKey : ctrlKey) && code == 88)
          replaceSelection("");
      }
    }
    function onKeyPress(e) {
      if (options.onKeyEvent && options.onKeyEvent(instance, addStop(e))) return;
			...
			if (typeof e.mobile !== "undefined") {
				if (typeof e.mobile.keyCode !== "undefined" && e.mobile.keyCode !== null)
					keyCode = e.mobile.keyCode;
				if (typeof e.mobile.charCode !== "undefined" && e.mobile.charCode !== null)
					charCode = e.mobile.charCode;
			}
